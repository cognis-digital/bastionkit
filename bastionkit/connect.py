"""Native cognis-connect emit for bastionkit — forward findings to any platform.

Maps bastionkit's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    bastionkit ... --format json | bastionkit-emit --to stix
    bastionkit-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
